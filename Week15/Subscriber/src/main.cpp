...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.18.203"; // Change to your MQTT broker IP
const int mqtt_port = 1883;

const char* TOPIC_TEMP = "home/AI_Lab00/temp"; // Topic for temperature
...
void connectMQTT() {
  while (!mqtt.connected()) {
    ...
    if (mqtt.connect("subscriber-Meerab")) {
