...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.18.203";  // Mosquitto / Cloud broker
const int   mqtt_port   = 1883;

// Topics
const char* TOPIC_TEMP = "home/AI_Lab00/temp";
const char* TOPIC_HUM  = "home/AI_Lab00/hum";
