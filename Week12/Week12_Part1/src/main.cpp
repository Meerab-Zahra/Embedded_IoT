...
#define BLYNK_TEMPLATE_ID "TMPL6rAJt_wDi"
#define BLYNK_TEMPLATE_NAME "DHT Meerab"
#define BLYNK_AUTH_TOKEN "JlbdRjT0NtsHUdAtedFLB_D5-R3PaLAa"// <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
